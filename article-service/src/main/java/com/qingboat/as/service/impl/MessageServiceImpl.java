...
public class MessageServiceImpl extends ServiceImpl<MessageDao, MessageEntity> implements MessageService {
    ...
    public void asyncSendSubscriptionMessage(UserSubscriptionEntity userSubscriptionEntity) {
        ...
        msg.setMsgTitle("感谢您成功订阅："+ createUser.getNickname()+"(" +tierEntity.getTitle() + "),<a href=\"" +  this.businessDomain+"/qwqr\">"  + "\uD83D\uDD17点击链接</a>加入创作者会员群");
        ...
        // 交易流水号
        String orderNo = userSubscriptionEntity.getOrderNo() ==null?"":userSubscriptionEntity.getOrderNo();
        data2.put("keyword5", JSON.parse("{'value': '"+orderNo +"'}"));
